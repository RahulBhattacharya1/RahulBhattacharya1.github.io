...
/* --- Fix heading bars inside accordion --- */
.role-slideshows .acc-item h3{
  margin:0;
  padding:0;
  border:0 !important;
...
.role-slideshows .acc-item h3::before,
.role-slideshows .acc-item h3::after{
  content:none !important;   /* some themes draw lines via pseudo-elements */
}
...
/* Kill theme heading rules inside the accordion */
.role-slideshows .acc-item h3{
  margin:0;
  padding:0;
  border:0 !important;
...
/* Some themes draw a top rule on the next sibling of h3 — remove it */
.role-slideshows .acc-item h3 + *,
.role-slideshows .acc-item .acc-panel{
  border-top:0 !important;
}

/* Make sure the content block itself isn’t drawing a rule */
.role-slideshows .acc-item .acc-panel .acc-body{
  border:0 !important;
  box-shadow:none !important;
}

/* If your theme targets .post-content/.is-post specifically, add this too */
.post-content .role-slideshows .acc-item h3,
.is-post .role-slideshows .acc-item h3{
  border:0 !important;
}
