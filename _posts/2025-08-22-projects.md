...
/* Kill theme's focus/active underline on accordion headers */
.role-slideshows .acc-item .acc-btn,
.role-slideshows .acc-item .acc-btn:focus,
.role-slideshows .acc-item .acc-btn:active {
  border: 0 !important;
  background: transparent !important;
  box-shadow: none !important;
  background-image: none !important; /* theme often uses gradient here */
}
