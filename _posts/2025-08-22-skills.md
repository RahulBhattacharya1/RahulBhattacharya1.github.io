  ...
  <section class="slideshows">
    ...
    <div class="slideshow-container" id="slideshowA" aria-label="Certificates Set A">
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/images/ai_image_classifier.webp" src="" loading="lazy" alt="Certificate A1">
      </div>
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/certs/cert1.webp?text=Cert+A2" src="" loading="lazy" alt="Certificate A2">
      </div>
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/certs/cert1.webp?text=Cert+A3" src="" loading="lazy" alt="Certificate A3">
      </div>
    ...
    <div class="slideshow-container" id="slideshowB" aria-label="Certificates Set B">
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/certs/cert1.webp?text=Cert+B1" src="" loading="lazy" alt="Certificate B1">
      </div>
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/certs/cert1.webp?text=Cert+B2" src="" loading="lazy" alt="Certificate B2">
      </div>
      <div class="slides fade">
        <img data-src="https://rahulbhattacharya1.github.io/assets/certs/cert1.webp?text=Cert+B3" src="" loading="lazy" alt="Certificate B3">
      </div>
      <button class="prev" aria-label="Previous slide" type="button">&#10094;</button>
      <button class="next" aria-label="Next slide" type="button">&#10095;</button>
    </div>
